...
The first step of this analysis was be to thoroughly explore this data set. In doing so,
...
there the number of dependants on each policy has a distribution that is skewed to the left, as
...
which would likely mean that the insurance company would pay out more in claims than it received in
premiums. 
...
Exhibit 31 is incredible to me, as it seems highly illogical. Exhibit 31 shows that from this subset of data, medical expenses are lower for smokers than for smokers, while non-smokers with a BMI of over 30 have lower expenses than those with a BMI of under 30. While this subset of data is not indicative of the whole data set, as shown by the proportion tables in Exhibits 29 and 30, it is interesting to see that the moderate expenses susbet is very different to both the first subset and the overall data set.
